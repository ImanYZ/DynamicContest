...
class Experiment(models.Model):
    ...
    training_number = models.IntegerField(default=6)
    contest_number = models.IntegerField(default=3)
    game_number = models.IntegerField(default=2)
    player_number = models.IntegerField(default=2)
    total_participants_number = models.IntegerField(default=12)
    ...
    game_max_minutes = models.IntegerField(default=100)
    game_max_seconds = models.IntegerField(default=0)
    game_minutes_to_reveal = models.IntegerField(default=1)
